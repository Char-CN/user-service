$(function() {
	$.ds = {
		url : {
			...
			save_role : "role/saveRole.do",
			del_role : "role/delRole.do",
			find_role_all : "role/findRoleAll.do",
			find_system_by_page : "system/findSystemByPage.do",
			find_system_by_id : "system/findSystemById.do",
